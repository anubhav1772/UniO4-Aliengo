...
from go1_gym_online.go1_gym_deploy.utils.deployment_runner import DeploymentRunner, CONT
from go1_gym_online.go1_gym_deploy.envs.lcm_agent import LCMAgent
from go1_gym_online.go1_gym_deploy.utils.cheetah_state_estimator import StateEstimator
from go1_gym_online.go1_gym_deploy.utils.command_profile import *
...
def run_sample(dirs, experiment_name, max_vel=1.0, max_yaw_vel=1.0, max_steps = 2048, state_dim=76, obs_dim = 58, action_dim=12, device = 'cuda:0'):
    ...
    # logdir = sorted(dirs)[-1]
    logdir = '/home/anubhav1772/Documents/unio4_real/runs/gait-conditioned-agility/itmo/train/113428.802625'
    ...
    from go1_gym_online.go1_gym_deploy.envs.history_wrapper import HistoryWrapper
    hardware_agent = HistoryWrapper(hardware_agent)

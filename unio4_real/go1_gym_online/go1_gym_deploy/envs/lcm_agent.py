...
from go1_gym_online.go1_gym_deploy.lcm_types.pd_tau_targets_lcmt import pd_tau_targets_lcmt
from go1_gym_online.go1_gym_deploy.lcm_types.obs_action_lcmt import obs_action_lcmt

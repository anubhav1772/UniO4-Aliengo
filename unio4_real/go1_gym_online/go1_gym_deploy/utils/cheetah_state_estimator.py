...
from go1_gym_online.go1_gym_deploy.lcm_types.leg_control_data_lcmt import leg_control_data_lcmt
from go1_gym_online.go1_gym_deploy.lcm_types.rc_command_lcmt import rc_command_lcmt
from go1_gym_online.go1_gym_deploy.lcm_types.state_estimator_lcmt import state_estimator_lcmt

def train_aliengo(headless=True):
    ...
    Cfg.reward_scales.estimation_bonus = 0.0
    Cfg.reward_scales.termination = 0.
    Cfg.reward_scales.tracking_lin_vel = 1.0
    Cfg.reward_scales.tracking_ang_vel = 0.5
    ...
    Cfg.reward_scales.feet_stumble = 0.
    Cfg.reward_scales.action_rate = -0.01
    Cfg.reward_scales.stand_still = 0.
    Cfg.reward_scales.tracking_lin_vel_lat = 0.
    Cfg.reward_scales.tracking_lin_vel_long = 0.
    Cfg.reward_scales.tracking_contacts = 0.
    Cfg.reward_scales.tracking_contacts_shaped = 0.
    Cfg.reward_scales.tracking_contacts_shaped_force = 4.0
    Cfg.reward_scales.tracking_contacts_shaped_vel = 4.0
    Cfg.reward_scales.jump = 10.0
    ...
    Cfg.reward_scales.feet_contact_forces = 0.
    Cfg.reward_scales.feet_slip = -0.04
    Cfg.reward_scales.feet_clearance_cmd_linear = -30.0
    Cfg.reward_scales.dof_pos = -0.0
    Cfg.reward_scales.action_smoothness_1 = -0.1 # -0.05
    Cfg.reward_scales.action_smoothness_2 = -0.1 # -0.05
    Cfg.reward_scales.base_motion = 0.
    Cfg.reward_scales.feet_impact_vel = -0.0
    Cfg.reward_scales.raibert_heuristic = -10.0
    Cfg.reward_scales.orientation_control = -5.0
    Cfg.reward_scales.tracking_stance_width = -0.0
